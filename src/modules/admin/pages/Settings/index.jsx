    ...
    <div className="p-4 md:p-6 space-y-6 bg-[var(--color-surface-dim)] min-h-screen">
      ...
      <StaggerGroup className="grid grid-cols-1 lg:grid-cols-10 gap-6">
        ...
        <StaggerItem className="lg:col-span-3">
          <div className="bg-gradient-to-br from-admin-primary via-admin-hover to-[#0a2a6e] rounded-xl p-6 shadow-lg text-white relative overflow-hidden hover:shadow-xl transition-shadow">
        ...
        <StaggerItem className="lg:col-span-7">
          <div className="bg-white rounded-xl border-2 border-danger/20 p-6 shadow-sm hover:shadow-md transition-shadow">
